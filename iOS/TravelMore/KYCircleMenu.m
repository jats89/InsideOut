...
@property (nonatomic) BOOL isLoadedOnce;
...
- (void)setUpWithButtonCount:(NSInteger)buttonCount
                           menuSize:(CGFloat)menuSize
                         buttonSize:(CGFloat)buttonSize
              buttonImageNameFormat:(NSString *)buttonImageNameFormat
                   centerButtonSize:(CGFloat)centerButtonSize
...
//        CGRectMake((CGRectGetWidth(menu_.frame) - centerButtonSize_) * .5f,
//                   (CGRectGetHeight(menu_.frame) - centerButtonSize_) * .5f,
//                   centerButtonSize_, centerButtonSize_);
        centerButton_ = [[UIButton alloc] init];
        centerButton_.translatesAutoresizingMaskIntoConstraints = NO;
        ...
        [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[centerButton_(centerButtonSize_)]" options:0 metrics:@{@"centerButtonSize_":@(centerButtonSize_)} views:@{@"centerButton_":centerButton_}]];
        [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[centerButton_(centerButtonSize_)]" options:0 metrics:@{@"centerButtonSize_":@(centerButtonSize_)} views:@{@"centerButton_":centerButton_}]];
        [self.view addConstraint:[NSLayoutConstraint constraintWithItem:centerButton_
